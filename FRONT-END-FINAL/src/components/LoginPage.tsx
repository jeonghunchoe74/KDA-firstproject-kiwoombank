  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-[#7C1D2E]/5 rounded-full blur-3xl"></div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center gap-6 mb-6">
              ...
              <div className="relative">
                <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-[#7C1D2E] to-[#6A1528] shadow-lg flex items-center justify-center transform hover:scale-105 transition-transform">
                  <span className="text-white text-3xl tracking-tight">ACI</span>
                </div>
                <div className="absolute -inset-1 bg-gradient-to-br from-[#7C1D2E] to-[#6A1528] rounded-2xl blur opacity-20 -z-10"></div>
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-white border-slate-300 focus:border-[#7C1D2E] focus:ring-[#7C1D2E]/20 transition-all"
              />
            </div>
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-[#7C1D2E] to-[#6A1528] hover:from-[#6A1528] hover:to-[#5A1220] text-white py-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.02]"
            >
              로그인
            </Button>
          </form>
