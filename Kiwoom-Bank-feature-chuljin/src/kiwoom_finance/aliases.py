...
KOR_KEY_ALIASES = {
    ...
    "equity_total": [
        "자본총계", "자본 총계", "자본총액", "자본 합계", "자본계", "자본과부채총계"
    ],
    "equity_parent": [
    ...
    "total_assets": [
        ...
        "부채와자본총계", "부채와 자본 총계", "자산과부채총계", "부채및자본총계"
    ],
    ...
    "finance_costs": [
        "금융비용", "이자비용", "금융원가", "이자비용(손실)", "이자비용및유사비용",
        "금융비용합계", "이자비용및수수료", "이자비용등", "이자비용순액"
    ],
    "net_income": [
...
CF_KEY_ALIASES = {
    ...
    # 이자지급(유출) — interest_coverage_ratio 대체식에서 사용
    "interest_paid": [
        "이자의 지급", "이자의지급", "이자지급", "이자지급액",
        "이자비용의 지급", "이자비용지급",
        "이자지급(영업)", "이자의 지급(영업)", "이자지급(영업활동)",
        "이자지급(재무활동)",  # 일부 회사는 재무활동에 표시
        "이자지급액(순액)", "이자지급(순액)"
    ],
}
